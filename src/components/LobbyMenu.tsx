        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-dnd-dark text-white p-4 font-sans relative overflow-hidden">
            ...
            <div className="max-w-4xl w-full relative z-10">
                ...
                <div className="flex justify-between items-start mb-16">
                    <div>
                        <h2 className="text-4xl font-fantasy text-dnd-gold mb-2">Welcome, Traveler</h2>
                    ...
                    <div className="space-y-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <h3 className="text-2xl font-fantasy text-white mb-2 group-hover:text-dnd-gold transition-colors">Create Campaign</h3>
                                    <p className="text-sm text-gray-400 leading-relaxed">Become the Host. Generate a new world code.</p>
                                </div>
                                <div className="flex items-center gap-2 text-dnd-gold font-bold uppercase tracking-wider text-xs opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-[-10px] group-hover:translate-x-0">
                                    {isLoading ? 'Creating...' : 'Start New Game'} <ArrowRight size={14} />
                                </div>
                            </motion.button>
                            ...
                            >
                                <div>
                                    ...
                                    <h3 className="text-2xl font-fantasy text-white mb-2 group-hover:text-blue-400 transition-colors">Join Party</h3>
                                    <p className="text-sm text-gray-400 leading-relaxed">Enter a code to join your friends.</p>
                                </div>
                        ...
                        {recentLobbies.length > 0 && (
                            <div className="bg-slate-900/50 rounded-2xl p-6 border border-gray-800">
                                <h3 className="text-lg font-bold text-gray-300 mb-4 flex items-center gap-2">
                                    <Clock size={16} /> Resume Adventure
                                </h3>
                                        ...
                                        >
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500 mt-1">
                                                    Last played: {new Date(lobby.updated_at).toLocaleDateString()}
                                                </div>
                                            </div>
                        ...
                        {!isLoadingLobbies && recentLobbies.length === 0 && (
                            <div className="text-center text-gray-600 text-sm">
                                No recent campaigns found. Start a new one!
                            </div>
                        )}
                    </div>
                )}
                ...
                {view === 'join' && (
                    ...
                    >
                        <div className="bg-slate-800/90 border border-gray-700 rounded-2xl p-8 shadow-2xl">
                            ...
                            <h3 className="text-2xl font-fantasy text-white mb-6">Enter Lobby Code</h3>
                            ...
                            <form onSubmit={handleJoinSubmit} className="space-y-4">
                                <input
                                    ...
                                    placeholder="e.g. dragon-keep-123"
                                ...
                                >
                                    {isLoading ? <Loader2 className="animate-spin" /> : 'Join Adventure'}
                                </button>
                            </form>
                        </div>
                    </motion.div>
